...
if __name__ == '__main__':
    ...
    input_files = [f for f in os.listdir(file_input_path) if re.search(r'.*\.(jpg|png|bmp|dib|jpe|jpeg|jp2|tif|tiff|CR2)$', f)]
    ...
    for infile in input_files:
        # Read image
        if infile.endswith(".CR2"):
        	im = read_raw_img(infile)
        else:
